...
pub fn run(){
    ...
    let results: (String, char, i32) = single_byte_xor_cipher(cleaned_hex_string);

    let (decrypted_string, key, best_score) = results;
...
mod tests {
    ...
    #[test]
    fn passed(){
        let (result_string, result_key, best_score) = single_byte_xor_cipher("1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736");
